...
To update the database use this command from the Web project folder (replace `FeedbackSystem` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../FeedbackSystem.Infrastructure/FeedbackSystem.Infrastructure.csproj -s FeedbackSystem.Web.csproj
```
